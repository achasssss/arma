    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          ...
          Guard  Against <br className="sm:block hidden" />{" "}
        ...
        <h1 className="font-poppins font-semibold ss:text-[55px] text-[52px] text-white ss:leading-[100.8px] leading-[75px] ">
          in Identity Verification.
        </h1>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Ensuring secure identity verification by safeguarding against deepfake technology.
        </p>
      </div>
